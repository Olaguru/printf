...
Our version of `printf` currently handles the following conversion specifiers:
...
| `d` | Prints integer (assumes base 10) |
| `i` | Prints integer (detects base automatically) |
...
```
$ git clone https://github.com/itzthem3ji/printf
```
...
- Support for '0' and '-' flags
- Support for precision of non-conversion modifiers
